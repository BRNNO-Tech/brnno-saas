...
export async function markLeadAsRead(leadId: string) {
  ...
  // First check if the lead exists and belongs to this business
  ...
  if (checkError || !lead) {
    // Lead doesn't exist or doesn't belong to this business
    // Silently return - this is not a critical error
    console.warn('Lead not found or access denied:', leadId)
    return
  }
