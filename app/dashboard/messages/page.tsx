...
export default function MessagesPage() {
  return (
    <div className="p-6">
      ...
      {/* Coming Soon Card */}
      <Card className="p-12 text-center bg-gradient-to-br from-blue-600/20 via-blue-500/10 to-purple-500/20 border-blue-500/30">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h2 className="text-2xl font-bold text-white">Coming Soon: Two-Way Messaging</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white/5 backdrop-blur-md rounded-lg p-4 border border-white/10">
              ...
              <h3 className="font-semibold mb-1 text-white">SMS Inbox</h3>
            ...
            <div className="bg-white/5 backdrop-blur-md rounded-lg p-4 border border-white/10">
              ...
              <h3 className="font-semibold mb-1 text-white">Auto-Replies</h3>
              <p className="text-sm text-zinc-400">
            ...
            <div className="bg-white/5 backdrop-blur-md rounded-lg p-4 border border-white/10">
              ...
              <h3 className="font-semibold mb-1 text-white">Team Access</h3>
              <p className="text-sm text-zinc-400">
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-xl border border-white/10 overflow-hidden">
            <div className="bg-zinc-800/50 px-4 py-3 border-b border-white/10 flex items-center justify-between">
              <span className="font-semibold text-white">Messages Preview</span>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="font-semibold text-sm text-white">John Smith</span>
