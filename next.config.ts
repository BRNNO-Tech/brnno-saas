...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    STRIPE_PRO_STRIPE_PRICE_ID: process.env.STRIPE_PRO_STRIPE_PRICE_ID,
    STRIPE_PRO_STRIPE_ANNUAL_PRICE_ID: process.env.STRIPE_PRO_STRIPE_ANNUAL_PRICE_ID,
    STRIPE_PRO_NO_STRIPE_PRICE_ID: process.env.STRIPE_PRO_NO_STRIPE_PRICE_ID,
    STRIPE_PRO_NO_STRIPE_ANNUAL_PRICE_ID: process.env.STRIPE_PRO_NO_STRIPE_ANNUAL_PRICE_ID,
  },
